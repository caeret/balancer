...
```shell
> git clone https://github.com/caeret/balancer.git
```
...
## Run
`Balancer` needs to configure the `config.yaml` file, see [config.yaml](https://github.com/caeret/balancer/blob/main/config.yaml) :
...
```shell
> go get github.com/caeret/balancer/balancer
```
...
If you are interested in contributing to balancer, please see here: [CONTRIBUTING](https://github.com/caeret/balancer/blob/main/CONTRIBUTING.md)

## License

balancer is licensed under the term of the [BSD 2-Clause License](https://github.com/caeret/balancer/blob/main/LICENSE)
